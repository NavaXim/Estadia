...
$stm = $conexion->prepare("SELECT id, tbl_usuario_area.id_usuario, CONCAT(ap_paterno,' ',ap_materno,', ',nombre) AS nombre, tbl_usuario_area.id_area, desc_area FROM `tbl_usuario_area` INNER JOIN tbl_usuarios ON tbl_usuario_area.id_usuario = tbl_usuarios.id_usuario inner join cg_area on tbl_usuario_area.id_area = cg_area.id_area");
$stm->execute();
...
<div class="d-flex bg-light rounded-3 justify-content-center">
    <div class="container-fluid py-3">
        <div class="row justify-content-center">
            <div class="card w-75">
                <div class="card-header"><i class="fa fa-users"></i><i class="fa fa-building"></i>
                    <strong>Responsables de Áreas</strong>
                </div>
                    <div class="card-body">
                            ...
                            <table id="tb_area" class="table table-striped responsive display" style="width:100%">
                                ...
                                <tbody>
                                    <?php foreach($area as $area) { ?>
                                        <tr class="">
                                            <td scope="row"><?php echo $area['id']; ?></td>
